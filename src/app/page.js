...
export default function Home() {
  return (
    <div className="max-w-2xl mx-auto py-4 px-4">
      ...
      <Button variant="default" className="mt-4">Let's work</Button>

      <section>
        <h1 className={`font-semibold text-xl mt-8 mb-4`}>Projects</h1>
      ...
      <section>
        <h1 className={`font-semibold text-xl mt-8 mb-4`}>Archived Projects</h1>
        <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
      ...
      <section>
        <h1 className={`font-semibold text-xl mt-8 mb-4`}>Open Source Contributions</h1>
      ...
      <section>
        <h1 className={`font-semibold text-xl mt-8 mb-4`}>Experience</h1>
        <div className="flex flex-col gap-4">
          {experience.map((ex, i) => (
            <ExperienceCard
              key={i}
